...
void printUsage(char* self){
    ...
    std::cout << "into a grid in 2D using Super Rays and Culling Region based Updates method." << std::endl;
    std::cout << "The output is a compact maximum-likelihood binary grid2D file(.bg2)" << std::endl;
    std::cout << "or a full occupancy representation file(.og2)." << std::endl;

    std::cout << "Options: " << std::endl;
    std::cout << " -i <InputFile.graph2d> (required)" << std::endl;
    std::cout << " -o <OutputFile.bg2 or OutputFile.og2> (required)" << std::endl;
